#---------------------------------------------------------
# Resource Group Creation for SQL MI
#----------------------------------------------------------
...
resource "null_resource" "failovergroup" {
  ...
  depends_on = [azurerm_resource_group_template_deployment.SQLMI_Primary]
}
...
resource "null_resource" "delay" {
  ...
  depends_on = [azurerm_resource_group_template_deployment.SQLMI_Primary, null_resource.failovergroup]
}
...
resource "null_resource" "secondaryltrpolicy" {
  ...
  depends_on = [azurerm_resource_group_template_deployment.SQLMI_Primary, null_resource.failovergroup, null_resource.delay]
}