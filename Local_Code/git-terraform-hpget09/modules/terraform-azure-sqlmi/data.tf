...
#---------------------------------------------------------
# Fetch RootManageSharedAccessKeyId 
#---------------------------------------------------------

data "azurerm_eventhub_namespace_authorization_rule" "eventhub_authorization_rule" {
  provider                = azurerm.GO01
  name                    = "RootManageSharedAccessKey"
  namespace_name          = element(lookup(var.eventhub_audit,var.location),1)
  resource_group_name     = element(lookup(var.eventhub_audit,var.location),0)
}
